...
@php
    $variantClass = \XmlBlade\LaravelHtmx\Enums\Variant::tryFrom($variant);
@endphp

@if($variantClass->value === 'success')
...
@elseif($variantClass->value === 'warning')
...
@elseif($variantClass->value === 'danger')
